...
const DeliveryDashboard = () => {
  ...
  const stats = {
    ...
    nonCommence: dashboardData.filter(ba => ba.ba_status === 'Non commencé').length,
    partiel: dashboardData.filter(ba => ba.ba_status === 'Partiel').length,
    complet: dashboardData.filter(ba => ba.ba_status === 'Complet').length,
    aucunArticle: dashboardData.filter(ba => ba.ba_status === 'Aucun article').length
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600">Total BAs</p>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 border border-red-200">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm font-medium text-red-600">Non commencé</p>
              <p className="text-2xl font-bold text-red-700">{stats.nonCommence}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 border border-yellow-200">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-yellow-700">{stats.partiel}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 border border-green-200">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm font-medium text-green-600">Complets</p>
              <p className="text-2xl font-bold text-green-700">{stats.complet}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600">Sans articles</p>
              <p className="text-2xl font-bold text-gray-700">{stats.aucunArticle}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 border border-gray-200">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          >
            ...
            <option value="aucun article">Aucun article</option>
          </select>
        </div>
      </div>
