 ...
 *              - 2 sous-onglets: Opérationnel (BT/BL) et Financier (Factures)
    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex gap-1 mb-4 border-b border-gray-200 dark:border-gray-700">
        ...
        >
          ...
          <span className="text-xs font-normal">(BT/BL)</span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-xs font-normal">(Factures)</span>
        </button>
      </div>

      {/* Contenu onglet Opérationnel */}
      {activeTab === 'operational' && (
        <>
          {/* Bouton PDF */}
