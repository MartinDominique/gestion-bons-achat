// components/PurchaseOrderManager.js - LAYOUT EXACT SELON L'IMAGE
'use client'
...
export default function PurchaseOrderManager({ user }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* En-tête EXACT comme sur l'image */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              {/* Bouton déconnexion retiré car géré par la navigation */}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Cartes de statistiques EXACTEMENT comme sur l'image */}
        <div className="grid grid-cols-4 gap-6 mb-8">
          {/* Total des Bons */}
          <div className="bg-white rounded-lg shadow border-l-4 border-blue-500 p-6">
            <div className="flex items-center">
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-600">Total des Bons</p>
        ...
        {/* Tableau EXACT comme sur l'image */}
      ...
      {/* GARDEZ VOS MODALES EXISTANTES - Modal de détails */}
      {selectedOrder && (
