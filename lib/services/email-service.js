...
class WorkOrderPDFService {
  ...
  addHeader(doc, workOrder) {
    ...
    // Colonne 1: Logo (espace réservé)
    doc.setFontSize(12);
    doc.setFont('helvetica', 'bold');
    doc.addImage('https://raw.githubusercontent.com/MartinDominique/gestion-bons-achat/main/public/logo.png', 'PNG', 20, 15, 40, 20); // Placeholder pour le logo
